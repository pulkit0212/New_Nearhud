...
class ExoPlayerManager(
    ...
    private fun visibleAreaOffset(player: CustomExoPlayer, parent: View): Float {
                ...
                RecyclerView.SCROLL_STATE_IDLE -> {
                    if (firstVisibleItem < 3) {
                        for (i in 0 until visibleCount) {
                            ...
                            if (masterExoPlayer != null && masterExoPlayer is CustomExoPlayer) {
                                play(view)
                            } else {
                                continue
                            }
                        ...
                        /*val masterExoPlayer = view.findViewById<View>(id)
                        if (masterExoPlayer != null && masterExoPlayer is ShubhamExoPlayer) {
    ...
    private fun PlayerView.getPlayerParent(): CustomExoPlayer? {
        if (this.parent != null && this.parent is CustomExoPlayer) {
            return this.parent as CustomExoPlayer
        }
        return null
    }
