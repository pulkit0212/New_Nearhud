...
class ReplyCommentAdapter (var context: Context) : RecyclerView.Adapter<ReplyCommentAdapter.ReplyCommentViewHolder>() {
    ...
    class ReplyCommentViewHolder(var binding: ItemReplyCommentBinding) : RecyclerView.ViewHolder(binding.root)
